...
// QVLQuoteData request payload
// swagger:parameters QVLQuoteData
type QVLQuoteDataInfo struct {
	// in:body
	Body resource.QVLQuoteData
}

// SGXQVLResponse response payload
// swagger:response SGXQVLResponse
type SGXQVLResponseInfo struct {
	// in:body
	Body resource.SGXQVLResponse
}
...
// swagger:operation POST /sgx_qv_verify_quote Quote sgx_qv_verify_quote
// ---
// description: |
